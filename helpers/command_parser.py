...
def predictor_command_parser(parser):
    ...
    parser.add_argument('--loss',
                        help='Loss function, choose between TOP1, BPR and Blackout (Sampling), or hinge, logit and '
                             'logsig (multi-targets), or CCE (Categorical cross-entropy)',
    ...
    parser.add_argument('--sampling_bias',
                        help='Sampling bias for cluster methods. 0. means uniform sampling, 1. means proportional to '
                             'the item frequency',
                        default=0., type=float)
    ...
    parser.add_argument('--c_sampling',
                        help='Number of sample for the clustering loss. If unset, the same samples are used for the '
                             'recommendation loss and for the clustering loss.',
                        default=-1, type=int)
    ...
    parser.add_argument('--cluster_type', choices=['softmax', 'mix', 'sigmoid'],
                        help='Type of clusters. Softmax puts every item in 1 and only 1 cluster. Sigmoid allow puts '
                             'items in 0 to n clusters. Mix puts items in 1 to n clusters.',
