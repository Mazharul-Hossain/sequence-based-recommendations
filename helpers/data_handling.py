...
class DataHandler(object):
    ...
    def __init__(self, dirname, extended_training_set=False, shuffle_training=False):
        ...
        extended_training_set: boolean
            If True, the extended training set is used, i.e. the file "train_set_sequences+" is loaded
            instead of "train_set_sequences".
    ...
    def item_popularity(self):
        """Returns the number of occurrences of an item in the training set.
        """
